...
<title>Admin Page-Grocerio</title>
...
<body>
 ...
 <div class="container admin mt-2">
     <%@ include file="components/message.jsp"%>
      ...
      <div class="row mt-3" >
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#add-user-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/user.png" alt="users_pic" >
                         </div>
                          <p class="text-lowercase text-muted mt-2 " style="font-size:22px">click to add users</p>
                          <h2 class="text-uppercase text-muted mt-1">Add Users</h2>
                     </div>
                 </div>
           </div>
       </div>   
 ...
 <!-- add user modal -->
 <div class="modal fade" id="add-user-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white">
        <h5 class="modal-title" id="exampleModalLongTitle" >Fill User details.</h5>
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                   <input type="text" class="form-control" name="userName" placeholder="Enter User name here" required>
               </div>
               <div class="form-group">
                   <input type="text" class="form-control" name="userPassword" placeholder="Enter User Password here" required>
               </div>
               <div class="form-group">
                   <input type="text" class="form-control" name="userMobile" placeholder="Enter Mobile Number here" required>
               </div>
               <div class="form-group">
                   <input type="text" class="form-control" name="userEmail" placeholder="Enter User email here" required>
               </div>
               <div class="form-group">
                   <input type="text" class="form-control" name="userAddress" placeholder="Enter User Address here" required>
               </div>
               <div class="form-group">
               ...
               <div class="container text-center">
                   <button class="btn custom-bg text-white">Add user</button>
  ...
  <tbody>
   ...
   %>
    <tr>
      ...
      <td class="mid-align"><a href="ProductOperationServlet?userId=<%=u.getUserId()%>&action=deleteUser"><input type="submit" class="btn btn-danger" value="Delete"></a></td>
      <td class="mid-align"><a href="ProductOperationServlet?userId=<%=u.getUserId()%>&action=makeAdmin"><input type="submit" class="btn btn-danger" value="Make admin"></a></td>
    </tr>
    <%
      }
    %>
