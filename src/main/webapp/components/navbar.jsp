...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>Grocerio</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
          ...
          <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item active">
             <div class="nav-link" data-toggle="modal" data-target=".getwalletmodal"><b>Wallet</b></div>
             </li>
             <li class="nav-item active">
...
<div class="text-right">
    <p style="font-size:25px;"><b>Total Price :&#8377;<%=new CartDaoImp().totalPriceFromCart(user.getUserId(), user.getUserPhone()) %>/- </b></p> 
</div>
<hr>
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phone.png" style="width:27px;" alt="img">+91 8081053006<br>
                <img src="images/mail.png" style="width:29px;" alt="img">sahill@gmail.com
            </b>
        </p>
        </div>
      </div>
